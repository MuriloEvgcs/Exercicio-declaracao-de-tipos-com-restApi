...
async function saveSpaceshipOnServer(spaceship) {
...
async function updateSpaceshipOnServer(spaceship) {
...
async function getSpaceshipsFromServer() {
    const response = await fetch('http://localhost:3000/spaceships');
    if (response.ok) {
...
async function findSpaceship(name) {
...
async function addCrewMember(member, spaceship) {
...
async function fourthMenuOption() {
